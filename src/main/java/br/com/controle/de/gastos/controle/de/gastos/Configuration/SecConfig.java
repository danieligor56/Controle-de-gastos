...
import br.com.controle.de.gastos.controle.de.gastos.Infra.SecurityFilter;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
		return httpSecurity.csrf(csrf -> csrf.disable())
				...
				.authorizeHttpRequests(authorize -> authorize
						...
						//.requestMatchers("http://localhost/swagger-ui/index.html#/").permitAll()
						.requestMatchers(HttpMethod.POST,"/new").hasRole("User")		
